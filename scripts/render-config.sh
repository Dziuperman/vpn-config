  ...
  awk \
    ...
    '
      BEGIN {
        ...
        print "[Proxy]"
        print "xray-vpn = vless," server_address "," xray_vless_port ",password=" xray_client_uuid ",tls=true,udp-relay=true,fast-open=true,peer=" xray_reality_server_name ",public-key=" xray_reality_public_key ",short-id=" xray_reality_short_id ",client-fingerprint=chrome"
